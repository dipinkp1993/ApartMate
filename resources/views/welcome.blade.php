...
<head>
    ...
    <!-- Page Title -->
    <title>ApartmentMate-Software</title>
    <!-- Favicon -->
    ...
    <nav class="navbar navbar-top-default navbar-expand-lg navbar-gradient nav-icon alt-font">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="agency">
                  <h5 style="color: #ffffff"><strong> <i class="fas fa-building" style="color:pink;"></i> ApartmentMate</strong></h5>
            ...
            <ul>    <!-- SLIDE  -->
                <li data-description="" data-easein="default" data-easeout="default" data-hideafterloop="0"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         'ApartmentMate' is a Web Appication which provides complete management of apartments.
                        It covers all requirements from short time requirments to long tem requirements.
                    </div>
            ...
            <div class="col-lg-7 mt-4 pt-3 mt-lg-0 pt-lg-0 wow fadeInLeft">
                ...
                <form class="contact-form">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <input class="form-control" id="your_name" name="your_name" placeholder="Name" required=""
                                       type="text">
                            </div>
                            <div class="form-group">
...
<!-- Mirrored from megaone.themesindustry.com/index-agency.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 May 2020 18:09:57 GMT -->
</html>